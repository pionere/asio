...
namespace detail {
  ...
  public:
    ...
    return_type get()
    {
      ...
      return static_cast<return_type&&>(value_);
    }
...
namespace detail {
  ...
  struct spawn_data : private noncopyable
  {
    ...
    spawn_data(Hand&& handler,
        bool call_handler, Func&& function)
      : handler_(static_cast<Hand&&>(handler)),
        call_handler_(call_handler),
        function_(static_cast<Func&&>(function))
    {
    }
      ...
      !is_convertible<Handler&, execution_context&>::value>::type*)
{
  ...
  helper.data_.reset(
      new detail::spawn_data<handler_type, function_type>(
        static_cast<Handler&&>(handler), true,
    ...
    const boost::coroutines::attributes& attributes)
{
  ...
  helper.data_.reset(
      new detail::spawn_data<Handler, function_type>(
        static_cast<Handler&&>(handler), false,
        static_cast<Function&&>(function)));
  helper.attributes_ = attributes;
